...
async function fetchConversation(participants) {
    const conversation = await db.ChatConversation.findOne({ participants: { "$all" : participants} })
...
async function saveMessage(params) {
    ...
    const participants = [params.from, params.to]
    let conversation = await db.ChatConversation.findOne({ participants: { "$all" : participants} });
    ...
    if (conversation) {
        ...
        // create conversation
        conversation = new db.ChatConversation({
            participants: [params.from, params.to],
